...
import recipes.example.reciperetrofitcoroutinesshimmerfb.databinding.ActivityDetailBinding
...
class DetailActivity : recipes.example.reciperetrofitcoroutinesshimmerfb.BaseActivity() {
